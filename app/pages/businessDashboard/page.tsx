...
const activityLog = [
  ...
  {
    text: "Your profile was viewed by Nexus Corp",
    time: "5h ago",
    type: "view",
  },
...
const ActivityChart = () => (
  <div className="relative h-48 w-full mt-4 overflow-hidden">
    ...
    <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
      ...
      <path
        d="M0,100 Q150,50 300,80 T600,40 T900,90 T1200,30 V150 H0 Z"
        fill="url(#chartGradient)"
      />
      <path
        d="M0,100 Q150,50 300,80 T600,40 T900,90 T1200,30"
        fill="none"
        stroke="#ff5720"
        strokeWidth="3"
        strokeLinecap="round"
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] md:flex font-inter text-slate-800">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            >
              ...
              <Link
                ...
                className="px-5 py-2.5 bg-[#ff5720] hover:bg-orange-600 text-white font-bold text-sm rounded-xl shadow-lg shadow-orange-200 transition flex items-center gap-2"
              >
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                ...
                <p className="text-sm text-gray-500">
                  You gained{" "}
                  <span className="text-green-600 font-bold">+124</span> new
                  followers
                </p>
                <ActivityChart />
              </div>
              ...
              <div className="relative w-full h-56 rounded-3xl overflow-hidden shadow-lg group cursor-pointer">
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-0.5 bg-[#ff5720] text-white text-[10px] font-bold uppercase rounded shadow-lg">
                      Active
                    </span>
                  </div>
              ...
              <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-gray-50 flex justify-between items-center">
                  ...
                  <button className="text-xs text-[#ff5720] font-bold hover:underline">
                    View All
                  </button>
                </div>
                <div className="p-0">
                  {recentSales.map((sale, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-4 hover:bg-gray-50 transition border-b border-gray-50 last:border-0"
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gray-100 overflow-hidden">
                          <img
                            src={`https://i.pravatar.cc/150?img=${sale.img}`}
                            alt="User"
                          />
                        </div>
                        <div>
              ...
              <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      key={i}
                      className={`flex flex-col items-center justify-center p-4 rounded-2xl transition hover:opacity-80 ${action.color}`}
                    >
                ...
                <div className="space-y-6 relative pl-2">
                  ...
                  {activityLog.map((log, i) => (
                    <div key={i} className="relative pl-6">
                      <div
                        className={`absolute -left-[5px] top-1.5 w-3 h-3 rounded-full border-2 border-white ${
                          log.type === "money" ? "bg-green-500" : "bg-gray-300"
                        }`}
                      ></div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <SpeechBubble
          text="This centralized business command center provides a comprehensive performance monitoring interface with real-time analytics, revenue tracking, event management overview, and audience demographic insights to facilitate data-driven decision-making and operational efficiency"
          color="#007AFF"
        />
      </div>
    </div>

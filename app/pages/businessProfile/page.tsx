      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="relative -mt-16 sm:-mt-24 mb-8 flex flex-col sm:flex-row items-end sm:items-end gap-6">
          ...
          <div className="flex-1 pb-2 text-center sm:text-left">
            <h1 className="text-3xl font-bold text-gray-900 sm:text-white sm:drop-shadow-md">
              Nexus Properties Ltd.
            </h1>
            <p className="text-gray-600 sm:text-gray-200 mt-1 sm:font-medium">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 mt-2">
              ...
              <span className="text-sm font-medium text-gray-600 sm:text-gray-200">
                (48 Reviews)
              </span>
            </div>
          </div>
          ...
          <div className="flex gap-3 pb-2 w-full sm:w-auto">
            <button className="flex-1 sm:flex-none bg-[#ff5720] hover:bg-orange-700 text-white px-6 py-2.5 rounded-lg font-semibold shadow-sm transition">
              Contact Us
            </button>
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                homes and investment opportunities. Our team of dedicated
                professionals ensures a seamless experience from viewing to
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  <svg
                    className="w-5 h-5 text-[#ff5720] mt-0.5"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
